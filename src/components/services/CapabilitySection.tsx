      ...
      <div className="grid gap-8 lg:grid-cols-2 lg:items-start lg:gap-12">
        ...
        <div className="space-y-6 lg:border-l lg:border-slate-200/60 lg:pl-8">
          <section className="space-y-2">
            ...
            <CollapsibleList items={covers} visibleCount={1} moreLabel="Show more coverage" lessLabel="Show less" />
          </section>
          ...
          <section className="space-y-2">
            ...
            <CollapsibleList items={outcomes} visibleCount={1} moreLabel="Show more outcomes" lessLabel="Show less" />
          </section>
