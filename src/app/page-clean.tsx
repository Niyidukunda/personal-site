...
export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-orange-50 to-red-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-700">
      {/* Professional Header */}
      <header className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-orange-200 dark:border-slate-700 sticky top-0 z-50">
        <div className="container mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
            {/* Logo/Brand */}
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 bg-gradient-to-r from-orange-500 to-red-600 rounded-lg flex items-center justify-center text-white font-bold text-sm">
                FN
              </div>
              <div>
                <div className="font-bold text-gray-900 dark:text-white text-lg">Fidel Niyidukunda</div>
                <div className="text-xs text-orange-600 font-medium">Full-Stack Developer</div>
              </div>
            </div>

            {/* Navigation */}
            <nav className="hidden md:flex items-center space-x-6">
              <a href="#projects" className="text-gray-700 dark:text-gray-300 hover:text-orange-600 transition-colors font-medium">Projects</a>
              <a href="#about" className="text-gray-700 dark:text-gray-300 hover:text-orange-600 transition-colors font-medium">About</a>
              <a href="#contact" className="text-gray-700 dark:text-gray-300 hover:text-orange-600 transition-colors font-medium">Contact</a>
            </nav>
          </div>
        </div>
      </header>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-400 leading-relaxed">
                I build <span className="text-orange-600 font-semibold">reliable web applications</span> with enterprise-level thinking while teaching coding to real students gives me <span className="text-red-600 font-semibold">unique user experience insights</span> most developers never get.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a
                  href="#projects"
                  className="bg-gradient-to-r from-orange-500 to-red-600 hover:from-orange-600 hover:to-red-700 text-white px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 text-center"
                >
                  View My Projects
                </a>
                <a
              ...
              <div className="flex items-center space-x-3 pt-8 border-t border-gray-200 dark:border-gray-700">
                ...
                <a href="https://delitweb.co.za" target="_blank" className="flex items-center space-x-2 text-orange-600 hover:text-red-600 transition-colors font-medium">
                  <div className="w-6 h-6 bg-gradient-to-r from-orange-500 to-red-600 rounded flex items-center justify-center text-white text-xs font-bold">
                    D
                  </div>
      ...
      {/* Footer */}
      <footer className="bg-gradient-to-r from-orange-900 via-red-900 to-orange-900 text-white py-16">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            <div className="flex justify-center space-x-8 mb-8">
              <a href="https://github.com/niyidukunda" target="_blank" className="hover:text-orange-300 transition-colors flex items-center space-x-2">
                <span>GitHub</span>
              </a>
              <a href="https://linkedin.com/in/fidel-niyidukunda" target="_blank" className="hover:text-orange-300 transition-colors flex items-center space-x-2">
                <span>LinkedIn</span>
              </a>
              <a href="mailto:fidel@delitweb.co.za" className="hover:text-orange-300 transition-colors flex items-center space-x-2">
                <span>Email</span>
              </a>
            </div>
            
            <div className="border-t border-orange-800 pt-8 mt-8">
              <p className="text-orange-200 mb-4">
                © 2025 Fidel Niyidukunda • Building reliable applications with real user insights
              </p>
              <div className="flex items-center justify-center space-x-3">
                <span className="text-orange-300 text-sm">Crafted with</span>
                <a href="https://delitweb.co.za" target="_blank" className="flex items-center space-x-2 text-orange-300 hover:text-white transition-colors font-medium">
